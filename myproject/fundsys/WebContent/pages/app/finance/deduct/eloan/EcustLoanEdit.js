...
define(function(require, exports) {
	exports.WinEdit = {
		...
		createAppWindow : function(){
			...
			this.appWin = new Ext.ux.window.MyWindow({width:800,height:430,tbar:this.apptbar,
		...
		createMainPanel : function(){
			...
			'<tr><th col="reg|te">放款手续费率</th> <td col="prate" >&nbsp;</td><th col="payDate">合约放款日</th> <td col="payDate"  colspan=3 >&nbsp;</td></tr>',
			FORMDIY_DETAIL_KEY
			];
