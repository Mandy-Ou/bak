...
define(function(require, exports) {
	exports.WinEdit = {
		...
		createAppWindow : function(){
			...
			this.appWin = new Ext.ux.window.MyWindow({width:800,height:500,tbar:this.apptbar,items : [this.mainPanel],
			listeners : {
				'hide':function(win){
		...
		submitData : function(fileInfos){
			...
			EventManager.get('./fcOverdueDeduct_readxls.action',{params:{key:_this.bussKey,filePath : filePath},sfn:function(json_data){
		...
		gatherData : function(json_data){
			...
			_this.appFrm.setFieldValue('contractIds',_this.ids);
		...
		mask : function(msg){
			...
			this.apptbar.disableButtons(Btn_Cfgs.FILE_IMPORT_BTN_TXT+","+Btn_Cfgs.DO_NOMAL_BTN_TXT+","+Btn_Cfgs.CLOSE_BTN_TXT);
		},
		unmask : function(){
