	...
	exports.WinEdit = {
		...
		createDetailPnl : function() {
			...
			'<tr><th col="code">放款单编号</th> <td col="code" >&nbsp;</td><th col="ccode">借款合同号</th> <td col="ccode" >&nbsp;</td><th col="name">客户姓名</th> <td col="name" >&nbsp;</td></tr>',
					...
					'<tr><th col="Gaccouont">放款银行帐号</th> <td col="Gaccouont" >&nbsp;</td><th col="GbankName">放款银行</th> <td col="GbankName"  colspan=3 >&nbsp;</td></tr>',FORMDIY_DETAIL_KEY
			];
			var detailCfgs_1 = [{
				 cmns: 'THREE',
				/* ONE , TWO , THREE */
				...
				callback : {
					sfn : function(jsonData) {
						...
						if(jsonData["ysMat"]){
							...
							ysMat = parseFloat(ysMat.replaceAll(",",""));
							if(ysMat){
			        	...
			        	if(jsonData["ysRat"]){
		        			...
		        			ysRat = parseFloat(ysRat.replaceAll(",",""));
		        			if(ysRat){
