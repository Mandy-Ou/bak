			...
			exports.WinEdit = {
				...
				getUrls : function() {
					...
					if (this.optionType == OPTION_TYPE.ADD) { // --> 新增
						/*--- 添加 URL --*/
						cfg = {
							params : {waterType:'2',recode : '200006'},
							defaultVal : {sysId:_this.sysId,waterType:'2'},
...
//					/*资源名称*/
//					var txt_Name = FormUtil.getHidField({fieldLabel : '资源名称',name:'name',width:200,maxLength:50});
					...
					var txt_id = FormUtil.getHidField({
						...
						var cbo_inType = FormUtil.getRCboField({
							...
							name : 'otherSort',	allowBlank : false,
							width:118,
							restypeId : '200006',
