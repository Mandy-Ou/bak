...
//					+ btnEditCoManHtml + btnDelCoManHtml + btnDetailCoManHtml;
		...
		createApplyPanel : function() {
			...
			var htmlArrs_1 = [
				...
				'</tr>',
				'<tr>' +
					'<th ><span>*</span><label col="borBank">借款银行</label></th> <td col="borBank" >&nbsp;</td>' +
					'<th ><span>*</span><label col="borAccount">借款帐号</label></th> <td col="borAccount" >&nbsp;</td>' +
				...
				'<tr>' +
					...
					'<th col="frate">滞纳金利率</th> <td col="frate" colspan=3>&nbsp;</td>' +
				'</tr>', 
				FORMDIY_DETAIL_KEY,
				'<tr>' +
