...
/**
 * 暂存的展期申请单 UI smartplatform_auto 2013-09-13 16:19:16
 */ 
cmw.skythink.TempExtensionApplyMgr = function(){
	this.init(arguments[0]);
}

Ext.extend(cmw.skythink.TempExtensionApplyMgr,Ext.util.MyObservable,{
	initModule : function(tab,params){
		this.module = new Cmw.app.widget.AbsGContainerView({
			id : ComptIdMgr.tempExtensionApplyMgrId,
			tab : tab,
			params : params,
			hasTopSys : false,
	...
	getToolBar : function(){
		...
		var barItems = [{
			...
			handler : function(){
				EventManager.deleteData('./fcExtension_delete.action',{type:'grid',cmpt:_this.appgrid,optionType:OPTION_TYPE.DEL,self:_this});
			}
		}/*,{
			token : '导出',
