...
//					+ btnEditCoManHtml + btnDelCoManHtml + btnDetailCoManHtml;
		...
		createApplyPanel : function() {
			...
			var structure = [
				{header: '姓名', name: 'name',width:100},{header: '性别',name: 'sex',width:60,renderer: function(val) {
					return Render_dataSource.sexRender(val);
			...
			var guaComboxAppGird = new Ext.ux.grid.AppComBoxGrid({
			    ...
			    showLoad : true,
			    isAll:true,
			    url : './crmGuaCustomer_gualist.action',
			    params : {custType:_this.custType,baseId :_this.baseId},
			    needPage : true,
			    keyField : 'id',
			    width: 200
			});
...
//				});
			...
			var fset_1 = FormUtil.createLayoutFieldSet({
						...
						fields : [comp_code, rad_loanMain, cbo_inType,
								rad_loanType,rad_limitType,guaComboxAppGird,  comp_loanLimit,txt_appAmount,
			...
			var fset_2 = FormUtil.createLayoutFieldSet({
				...
				cmns : FormUtil.CMN_THREE,
				fields : [rad_rateType, dob_rate, rad_isadvance, rad_mgrtype,
						dob_mrate, dob_prate, dob_arate, dob_urate, dob_frate]
			}]);
