...
define(function(require, exports) {
	exports.moduleUI = {
		...
		getOneCustDetailPanel : function() {
			var _this = this;
			var htmlArrs_1 = [
					'<tr><th col="code">客户编号</th> <td col="code" >&nbsp;</td><th col="loanCode">借款合同号</th> <td col="loanCode" >&nbsp;</td><th col="custType" id="'+this.idMgr.custTypeId+'">客户类型</th> <td col="custName" >&nbsp;</td></tr>',
...
//						var codeid = _this.addAHtml(jsonData, 'code', '点击查看申请单详情！');//为展期申请单添加连接
						var loanCodeId = _this.addAHtml(jsonData,'loanCode','点击查看借款合同详情！');
						var custNameId = _this.addAHtml(jsonData,'custName','点击查看客户资料详情！');
			            ...
			            var extensionParams = {sysid:sysid,formId:jsonData["appid"]};
//						_this.viewExtensionDetailInfo(codeid,extensionParams);
						...
						var label_custType = Ext.get(_this.idMgr.custTypeId);
			...
			var delay = new Ext.util.DelayedTask(function(){
				...
				ele.on('click',function(e){
					...
					if(_this.appExtenCmpt){
						...
						Cmw.importPackage(Flow_CustForm_Url.B9999,function(mode){
						 _this.appExtenCmpt = mode.moduleUI;
						  _this.appExtenCmpt.show(extensionParams);
						});
					}
				});
		...
		getEntCustDetailPanel : function() {
			var _this = this;
			var htmlArrs_1 = [
					'<tr><th col="code">客户编号</th> <td col="code" >&nbsp;</td><th col="name">企业名称</th> <td col="name" >&nbsp;</td><th col="GuaId">担保人</th> <td col="GuaId" >&nbsp;</td></tr>',
