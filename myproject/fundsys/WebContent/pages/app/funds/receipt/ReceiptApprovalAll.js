 ...
 */ 
cmw.skythink.ReceiptApprovalAll = function(){
	this.init(arguments[0]);
}

Ext.extend(cmw.skythink.ReceiptApprovalAll,Ext.util.MyObservable,{
	initModule : function(tab,params){
		this.module = new Cmw.app.widget.AbsGContainerView({
			querytitle : '汇票收条一览表',//重写主题
			tab : tab,
			params : params,
			hasTopSys : false,
