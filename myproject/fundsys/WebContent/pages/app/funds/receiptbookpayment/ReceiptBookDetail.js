...
//			var htmlArr = ['<iframe id="'+this.iframeId+'" name="'+this.iframeId+'"  style="width:100%; height:100% " frameborder="0" src="pages/app/funds/receiptbookpayment/ReceiptBookEdit.jsp'+this.globalMgr.params+'"></iframe>'];
			var iframeHtml = htmlArr.join(" ");
			this.appWin = new Ext.ux.window.MyWindow({title : "汇票承诺书详情",width:900,height:600,autoScroll:true,draggable:true,maximizable:true,minimizable:true,tbar:this.tbar,html :iframeHtml});
...
//				var url = iframeEle.dom.src;
	...
	//			var form = iframeEle.document.forms[0];
		...
		globalMgr : {
			params : null,
			url : 'pages/app/funds/receiptbookpayment/ReceiptBookEdit.jsp',
			id : null,
			orgtype: null
		},
