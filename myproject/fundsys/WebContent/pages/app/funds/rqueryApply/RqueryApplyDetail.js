...
define(function(require, exports) {
	exports.viewUI = {
		...
		createAppWindow : function(){
			...
			this.iframeId = Ext.id(null,'rqueryApplyDetail');  
...
//			var htmlArr = ['<iframe id="'+this.iframeId+'" name="'+this.iframeId+'"  style="width:100%; height:100% " frameborder="0" src="pages/app/funds/rqueryApply/RqueryApplyEdit.jsp'+this.globalMgr.params+'"></iframe>'];
			var iframeHtml = htmlArr.join(" ");
			this.appWin = new Ext.ux.window.MyWindow({title : "汇票查询单详情",width:900,height:600,autoScroll:true,draggable:true,maximizable:true,minimizable:true,tbar:this.tbar,html :iframeHtml});
		},
		getToolBar : function(){
			var _this = this;
			var toolBar = null;
...
//				var url = iframeEle.dom.src;
	...
	//			var form = iframeEle.document.forms[0];
		...
		globalMgr : {
			params : null,
			url : 'pages/app/funds/rqueryApply/RqueryApplyEdit.jsp',
			id : null,
			orgtype: null
		},
