	...
	globalMgr : {
		...
		openPrintDialog : function(parentCfg){
			...
			var contractId = _this.globalMgr.id;
		 	var loanId= _this.globalMgr.formId;
			...
			if(_this.appCmpts[winkey]){
				...
				EventManager.get("./fcFuntempCfg_getTidByMid.action",{params:{menuId:_this.params.nodeId,loanId:loanId},sfn : function(jsonData){
