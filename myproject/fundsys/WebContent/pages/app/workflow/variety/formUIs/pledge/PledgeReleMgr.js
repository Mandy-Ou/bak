...
Ext.extend(skythink.cmw.workflow.bussforms.PledgeMgr,Ext.util.MyObservable,{
	...
	notify : function(data){
		...
		this.globalMgr.appgrid.reload({gtype:this.globalMgr.gvlistid,formId:this.globalMgr.formId,state:"2,1"});//点击系统图标时候加载树
	},
	getToolBar : function(){
	...
	refresh:function(optionType,data){
		...
		var _this = this;
		this.globalMgr.appgrid.reload({gtype:this.globalMgr.gvlistid,formId: this.globalMgr.formId,state:"2,1"},function(){
			switch(optionType){
