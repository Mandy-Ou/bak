	...
	getAppCmpt : function(){
		...
		this.globalMgr.tabs = tabs;
			...
			appPanel.addListener('afterrender',function(){
				var height = _this.globalMgr.appgrid.getHeight();
		...
		createDetailPnl : function(){
			...
			var htmlArrs_1 = [
						...
						'<tr>' +
							...
							'<th col="unAmount">未放款余额</th> <td col="unAmount" >&nbsp;</td>' +
						'</tr>',
						'<tr>' +
							'<th col="payAmount">放款金额</th> <td col="payAmount" colspan="3">&nbsp;</td>' +
...
//			        		detailPanel_1.hide();
			        	...
			        	jsonData["mrate"]  = jsonData["mrate"] ? jsonData["mrate"] +'%' : '';
