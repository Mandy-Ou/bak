...
define(function(require, exports) {
	exports.moduleUI = {
		...
		creatAppForm : function(){
			...
			var fset_1 = FormUtil.createLayoutFieldSet({title: '审批意见填写'+dispCurrLabel},[hid_nodeId,hid_taskId,hid_result,txa_approval, this.nextTransFieldSet,
			{cmns:'TWO',fields:[chk_reminds,rad_remindsStartor]}]);
			var _this = this;
			var frm_cfg = {hidden:true,url: './sysBussProccFlow_submit.action',
		...
		loadData : function() {
			...
			EventManager.get('./sysBussProccFlow_getTask.action',{params:params,sfn:function(json_data){
		...
		destroy : function(){
			...
			if(null != this.nextTransFieldSet){
				 this.nextTransFieldSet.destroy();
				 this.nextTransFieldSet = null;
			}
