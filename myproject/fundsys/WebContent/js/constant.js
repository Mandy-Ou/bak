...
/*===========================委托合同表单个性化id  ================*/
	 ...
	 * 委托合同申请
	 */
	FROMDIY_EntrustContract : 'FROMDIY_EntrustContract_112'
}
...
CUSTTAB_ID = {
	 ...
	 * @type String
	 */
	entrustCustMgrTabId : 'entrust_form_tabid_3',
	 ...
	 * @type String
	 */
	flow_EntrustConMainUI : {
		id : 'flow_EntrustConMainUI_tabid_1',
		url : 'pages/app/workflow/variety/mainUIs/EntrustContractMainUI.js'
	},
	/**
	 * 用户数据访问权限编辑面板 TAB ID
	 * 
	 ...
	 */
	CusInfoDetailTab : {
		id : 'custInfoDetail_tabid_9',
		url : 'pages/app/funds/amountapply/AmountApplyDetil.js'
	},
	/**
	 * 企业客户详情TAB ID
	 */
	 ...
	 * @type String
	 */
	tempBamountApplyMgrTabId : 'tempBamountApplyMgrTabId_tabid_20',
	/**
	 * 暂存的增资申请单
	 * 
	 * @type String
	 */
	tempAamountApplyMgrTabId : 'tempAamountApplyMgrTabId_tabid_21',
	/**
	 * 子业务流程审批主面板 TAB ID
	 * 
	 * @type String
	 ...
	 * @type String
	 */
	entrustContractTabId : 'entrustContract_tabid_18',
	/**
	 * 展期申请单ID
	 * 
	 * @type String
	 */
	bamountApplay : 'bamountApplay_tabid_18',
	/**
	 * 提前还款申请单ID
	 * 
	 * @type String
	 ...
	 * @type String
	 */
	TempEntrustCust : 'TempEntrustCust_tabid_1',
	/**
	 * 业务流程审批主面板 TAB ID
	 * 
	 * @type String
	 */
	flow_TempEntrustCust : {
		id : 'flow_TempEntrustCust_tabid_2',
		url : 'pages/app/funds/entrustcontract/TempEntrustCust.js'
	},
	/**
	 *委托合同申请审批主面板 TAB ID
	 * 
	 * @type String
	 */
	entrustApplyMainUITab : {
		id : 'entrustApplyMainUITab_tabid_1',
		url : 'pages/app/workflow/variety/mainUIs/AuditMainUI.js'
	},
	/**
	 * 提前还款申请单详情
	 ...
	 * 资金追加申请 TAB ID
	 */
	AmountProofTabId : {id:'AmountProofMgr_TabId_31',url:'pages/app/finance/bloan/addApply/AddApply.js'},
	
	/**
	 * 资金追加暂存 TAB ID
	 */
	temAmountProofTabId : {id:'temAmountProofMgr_TabId_32',url:'pages/app/finance/bloan/addApply/TempAddApplyMgr.js'},
	 ...
	 */
	detailApplyTabId : {
		id : 'detailApplyForm_tabid_33',
		url : 'pages/app/finance/bloan/addApply/applyDetail.js'
	},
	/**
	 * 业务流程审批主面板 TAB ID
	 * 资金追加暂存
	 * @type String
	 */
	flow_AmountProofUITab : {
		id : 'flow_auditMainUI_tabid_34',
		url : 'pages/app/workflow/variety/mainUIs/AuditMainUI.js'
	}
}
...
var ComptIdMgr = {
	 ...
	 *    撤资流程审批面板ID
	 */
	tempBamountApplyMgrId : Ext.id(null, 'tempBamountApplyMgrId'),
	/**
	 * 增资流程审批面板ID
	 */
	 ...
	 * 委托人
	 */
	tempCustMgrId : Ext.id(null, 'TempCustMgrId'),
	/**
	 * 企业客户贷款一览表面板ID
	 */
	 ...
	 * @type String
	 */
	tempAmountApplyMgrId : Ext.id(null, 'tempAmountApplyMgrId'),
	...
	getBussProccApplyRefreshIds : function() {
		return [this.tempExtensionApplyMgrId, this.tempPrepaymentApplyMgrId,
				this.tempExemptApplyMgrId, this.auditExtensionMgrId,this.tempAmountApplyMgrId];
	},
	/**
	 * 桌面模块 --> 待审批的个人贷款
	 * 
	 ...
	 * @type
	 */
	flowRefreshIdsArr : [this.tempCustApplyMgrId, this.tempEntCustApplyMgrId,this.tempBamountApplyMgrId,
			this.auditCustApplyMgrId, this.auditEntCustApplyMgrId,
			this.auditCustApplyAllId, this.auditEntCustApplyAllId,
			this.tempCustMgrId, this.tempCustMgrId,
			this.auditCustApplyHistoryId, this.auditEntCustApplyHistoryId,
...
var Flow_CustForm_Url = {
	 ...
	 * @type String
	 */
	B0004 : 'pages/app/workflow/variety/mainUIs/EntCDetailMod.js',
	/**
	 * 贷款申请单详情
	 * 
	 * @type String
	 */
	B0005 : 'pages/app/finance/bloan/addApply/AddApplyDetailMod.js'
		,/**
		 * 展期内容对应的审批详情表单
		 * 
		 * @type String
		 */
	B6666 : 'pages/app/workflow/bussProcc/formUIs/AmountMod',
		/**
	 * 展期内容对应的审批详情表单
	 * 
	 * @type String
	 */
	B8888 : 'pages/app/workflow/bussProcc/formUIs/EntrustCustlMod',
	/**
	 * 汇票收条
	 * @type String
	 */
	B5222 : 'pages/app/funds/receipt/ReceiptApply'
}
/**
...
var ApplyActivePnlId = {
	...
	topActiveRecipt : Ext.id(null,'topActiveRecipt')
}