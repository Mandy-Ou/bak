 ...
 *  	
 */
Cmw.app.widget.AbsTreeGridView = Ext.extend(Ext.Panel,{
	toolBar : null,
	apptree : null,
	appgrid : null,
	globalMgr : null,
	...
	buildCmpts : function(){
		...
		this.apptree.region = 'center';
		this.apptree.border = true;
		this.item1 = this.apptree;
//		this.item1 = new Ext.Panel({region:'center',items : [this.apptree]});
//		this.appgrid = this.getTestGrid();
		this.appgrid.region = 'east';
		this.appgrid.border = true;
		this.item2  = this.appgrid;
//		this.item2 = new Ext.Panel({region:'east',items : [this.appgrid]});
