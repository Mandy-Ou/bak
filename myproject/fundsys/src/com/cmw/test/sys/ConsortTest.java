...
public class ConsortTest extends AbstractTestCase {
	@Resource(name="consortService")
	private ConsortService consortService;
//	@Test
...
//	}
	...
	public void testgetResultList() throws ServiceException{
		...
		DataTable dt = consortService.getResultList(map,0,20);
