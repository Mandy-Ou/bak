...
public class ExtPlanPayTypeTest extends AbstractTestCase {
...
//		loanContractEntity.setMrate(0.6);
		...
		Long invoceId = 1L;
		LoanInvoceEntity invoceEntity = loanInvoceService.getEntity(invoceId);
		Map<String,Object> params = new HashMap<String, Object>();
		params.put("loanInvoceId", invoceEntity.getId());
		params.put("realDate", DateUtil.dateFormat("2012-02-28"));//invoceEntity.getRealDate()
		...
		PayTypeCalculateAbs  paytypeObj = factory.creator("P0003");
