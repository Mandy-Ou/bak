...
public class ShareInfoTranAction extends BaseAction {
	@Resource(name="shareInfoTranService")
	private ShareInfoTranService shareInfoTranService;
	...
	public String get()throws Exception {
		try {
			...
			ShareInfoTranEntity entity = shareInfoTranService.getEntity(Long.parseLong(id));
	...
	public String add()throws Exception {
		try {
			Long num = shareInfoTranService.getMaxID();
	...
	public String enabled(String sucessMsg)throws Exception {
		try {
			...
			shareInfoTranService.enabledEntitys(ids, isenabled);
	...
	public String prev()throws Exception {
		try {
			...
			ShareInfoTranEntity entity = shareInfoTranService.navigationPrev(params);
	...
	public String next()throws Exception {
		try {
			SHashMap<String,Object> params = getQParams("id");
			ShareInfoTranEntity entity = shareInfoTranService.navigationNext(params);
