 ...
 */
@Description(remark="回款收条表ACTION",createDate="2014-02-20T00:00:00",author="郑符明",defaultVals="fuBackReceipt_")
@SuppressWarnings("serial")
public class BackReceiptAction extends BaseAction {
	@Resource(name="backReceiptService")
	private BackReceiptService backReceiptService;
	...
	public String list()throws Exception {
		try {
			String qCmns = "name,operational,amount#O,outDate,endDate,rnum,rtacname,rtaccount";//根据条件进行查询
			SHashMap<String, Object> map = getQParams(qCmns);
			map.put(SysConstant.USER_KEY, this.getCurUser());
			DataTable dt = backReceiptService.getResultList(map,getStart(),getLimit());
	...
	public String get()throws Exception {
		try {
			...
			BackReceiptEntity entity = backReceiptService.getEntity(Long.parseLong(id));
	...
	public String add()throws Exception {
		try {
			Long num = backReceiptService.getMaxID();
	...
	public String enabled(String sucessMsg)throws Exception {
		try {
			...
			backReceiptService.enabledEntitys(ids, isenabled);
	...
	public String prev()throws Exception {
		try {
			...
			BackReceiptEntity entity = backReceiptService.navigationPrev(params);
	...
	public String next()throws Exception {
		try {
			SHashMap<String,Object> params = getQParams("id");
			BackReceiptEntity entity = backReceiptService.navigationNext(params);
