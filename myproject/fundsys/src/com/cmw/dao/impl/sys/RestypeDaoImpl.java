...
public <K, V> DataTable getLoanRecordsList(SHashMap<K, V> params,
		int offset, int pageSize) throws DaoException {		params = SqlUtil.getSafeWhereMap(params);
		StringBuilder sb = new StringBuilder();
		sb.append("select A.id,A.name from ts_Variety A ")
		.append(" where A.isenabled='"+SysConstant.OPTION_ENABLED+"' ");
		try {
				Long sysId = params.getvalAsLng("sysId");/*编号*/
