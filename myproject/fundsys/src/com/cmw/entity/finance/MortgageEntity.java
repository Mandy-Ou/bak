 ...
 */
@Description(remark="抵押物实体",createDate="2013-01-06T00:00:00",author="pdh")
@Entity
@Table(name="fc_Mortgage")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("serial")
public class MortgageEntity extends IdBaseEntity {
	 ...
	 @Description(remark="抵押物类型")
	 @Column(name="gtype" ,nullable=false )
	 private Long gtype;

	 @Description(remark="抵押物名称")
	 ...
	 @Column(name="unint" ,length=20 ,scale=0)
	 ...
	 @Description(remark="抵押价值")
	 @Column(name="mpVal" ,nullable=false ,scale=0)
	 ...
	 @Description(remark="抵押时间")
	 @Column(name="morTime" )
	 private Date morTime;

	 @Description(remark="抵押物所在地")
	...
	**/
	...
	public Object[] getDatas() {
		return new Object[]{id,code,formId,gtype,name,quantity ,unint,oldVal,mpVal,mman,conTel,morTime,address,carrTime,carrMan,charTime,charMan ,state,remark};
	}

	@Override
	public String[] getFields() {
		return new String[]{"id","code","formId","gtype","name","quantity ","unint","oldVal","mpVal","mman","conTel","morTime#yyyy-MM-dd","address","carrTime#yyyy-MM-dd","carrMan","charTime#yyyy-MM-dd","charMan ","state","remark"};
	}
