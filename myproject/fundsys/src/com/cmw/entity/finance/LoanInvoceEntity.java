...
public class LoanInvoceEntity extends IdBaseEntity {
	 ...
	 @Column(name="regBank" ,nullable=false ,length=50 )
	...
	**/
	...
	public Object[] getDatas() {
		return new Object[]{id,isenabled,code,formId,contractId,payName,regBank,account,payAmount,prate,cashier,payDate,realDate,accountId,fcnumber,auditState,state,unAmount,startWay};
	}

	@Override
	public String[] getFields() {
		return new String[]{"id","isenabled","code","formId","contractId","payName","regBank","account","payAmount","prate","cashier","payDate#yyyy-MM-dd","realDate#yyyy-MM-dd","accountId","fcnumber","auditState","state","unAmount","startWay"};
	}
