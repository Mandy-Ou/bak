...
public class ExtensionEntity extends IdBaseEntity {
	...
	**/
	...
	public Object[] getDatas() {
		return new Object[]{id,code,breed,procId,contractId,loanCode,guaCode,ostartDate,oendDate,endAmount,extAmount,yearLoan,monthLoan,dayLoan,estartDate,eendDate,payType,phAmount,rateType,rate,isadvance,mgrtype,mrate,ctype,extReason,paySource,applyMan,applyDate,comeDate,managerId,status,isenabled};
	}

	@Override
	public String[] getFields() {
		return new String[]{"id","code","breed","procId","contractId","loanCode","guaCode","ostartDate","oendDate","endAmount","extAmount","yearLoan","monthLoan","dayLoan","estartDate","eendDate","payType","phAmount","rateType","rate","isadvance","mgrtype","mrate","ctype","extReason","paySource","applyMan","applyDate","comeDate","managerId","status","isenabled"};
	}
