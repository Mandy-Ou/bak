 ...
 */
@Description(remark="抵押合同实体",createDate="2013-01-11T00:00:00",author="pdh")
@Entity
@Table(name="fc_MortContract")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("serial")
public class MortContractEntity extends IdBaseEntity {
	...
	@Description(remark="客户类型")
	 ...
	 @Column(name="assMan" ,nullable=false ,length=50 )
	 ...
	 @Description(remark="抵押人")
	 @Column(name="pleman" ,nullable=false )
	 private String pleman;
	 ...
	 @Column(name="pleIds" ,nullable=false ,length=150 )
	...
	/**设置抵押人
	 * @param pleman the pleman to set
	 */
	public void setPleman(String pleman) {
		this.pleman = pleman;
	}
	...
	**/
	...
	public Object[] getDatas() {
		return new Object[]{custType,customerId,id,isenabled,formId,loanConId,borrCode,assMan,appAmount,rate,startDate,endDate,code,sdate,ownerNums,pleIds,clause,pleman,conAmount};
	}

	@Override
	public String[] getFields() {
		return new String[]{"custType","customerId","id","isenabled","formId","loanConId","borrCode","assMan","appAmount","rate","startDate#yyyy-MM-dd","endDate#yyyy-MM-dd","code","sdate#yyyy-MM-dd","ownerNums","pleIds","clause","pleman","conAmount"};
	}
