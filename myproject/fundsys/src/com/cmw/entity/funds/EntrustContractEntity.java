 ...
 */
@Description(remark="委托合同实体",createDate="2014-01-20T00:00:00",author="李听")
@Entity
@Table(name="fu_EntrustContract")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("serial")
public class EntrustContractEntity extends IdBaseEntity {
	 @Description(remark="委托客户ID")
	 @Column(name="entrustCustId" ,nullable=false )
	 private Long entrustCustId;
	 @Description(remark="增资申请单ID")
	...
	@Description(remark="合同编号")
	 ...
	 @Description(remark="延期次数")
	 @Column(name="delayCount" ,nullable=false )
	...
	**/
	...
	public Object[] getDatas() {
		return new Object[]{id,entrustCustId,code,payBank,payAccount,accName,appAmount,yearLoan,monthLoan,payDate,endDate,setdayType,payDay,iamount,rateType,rate,unint,prange,productsId,doDate,clause};
	}

	@Override
	public String[] getFields() {
		return new String[]{"id","entrustCustId","code","payBank","payAccount","accName","appAmount","yearLoan","monthLoan","payDate#yyyy-MM-dd","endDate#yyyy-MM-dd","setdayType","payDay","iamount","rateType","rate","unint","prange","productsId","doDate#yyyy-MM-dd","clause"};
	}
