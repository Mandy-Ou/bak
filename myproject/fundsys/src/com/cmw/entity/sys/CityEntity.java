 ...
 */
@Description(remark="城市实体",createDate="2012-12-10T00:00:00",author="彭登浩")
@Entity
@Table(name="ts_city")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("serial")
public class CityEntity extends IdBaseEntity {
	...
	**/
	...
	public Object[] getDatas() {
		return new Object[]{id,isenabled,code,name,isdefault,provinceId,ename,jname,twname,fname,koname};
	}

	@Override
	public String[] getFields() {
		return new String[]{"id","isenabled","code","name","isdefault","provinceId","ename","jname","twname","fname","koname"};
	}
