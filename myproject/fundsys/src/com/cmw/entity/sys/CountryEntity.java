 ...
 */
@Description(remark="国家实体",createDate="2012-12-10T00:00:00",author="彭登浩")
@Entity
@Table(name="ts_country")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("serial")
public class CountryEntity extends IdBaseEntity {
	...
	**/
	 ...
	 * 是否默认显示--->0:表示否
	 */
	public static final Integer COUNTRY_ISDEFAULT_0=0;
	
	/**
	 * 是否默认显示--->1:表示是
	 */
	public static final Integer COUNTRY_ISDEFAULT_1=1;
	
	@Override
	public Object[] getDatas() {
		return new Object[]{id,isenabled,code,name,isdefault,restypeId,ename,jname,twname,fname,koname};
	}

	@Override
	public String[] getFields() {
		return new String[]{"id","isenabled","code","name","isdefault","restypeId","ename","jname","twname","fname","koname"};
	}
