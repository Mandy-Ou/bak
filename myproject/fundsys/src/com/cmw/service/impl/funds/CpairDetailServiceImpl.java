...
@Service("cpairDetailService")
public class CpairDetailServiceImpl extends AbsService<CpairDetailEntity, Long> implements  CpairDetailService {
	@Autowired
	private CpairDetailDaoInter cpairDetailDao;
	@Override
	public GenericDaoInter<CpairDetailEntity, Long> getDao() {
		return cpairDetailDao;
	}
	@Override
	public DataTable getDataSource(HashMap<String, Object> params)
			throws ServiceException {
		try {
			DataTable dt = cpairDetailDao.getResultList(new SHashMap<String, Object>(params), -1, -1);
			return dt;
