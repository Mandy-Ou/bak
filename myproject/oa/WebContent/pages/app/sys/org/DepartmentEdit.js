...
define(function(require, exports) {
	exports.WinEdit = {
		...
		createForm : function(){
			...
			/*部门名字*/
			var txt_name = FormUtil.getTxtField({fieldLabel : '部门名称',name:'name',width:140,allowBlank : false,maxLength:100});
			/*部门类型*/
			var rad_dtype = FormUtil.getRadioGroup({fieldLabel : '部门类型',name:'dtype',allowBlank : false,width:180,
				items : [{boxLabel : '行政部门', name:'dtype',inputValue:1},{boxLabel : '营销部门', name:'dtype',inputValue:2}]});
			/*拼音助记码*/
			...
			var layout_fields  = [
				    	          ...
				    	          {cmns:'THREE',fields:[txt_code,txt_name,rad_dtype,txt_mnemonic,txt_mperson,txt_builddate,txt_contactor,txt_tel,txt_zipcode]},
