...
Ext.extend(skythink.cmw.workflow.bussforms.LoaninvoceMgr,Ext.util.MyObservable,{
	...
	changeSize : function(whArr){
		/*var width = whArr[0];
		this.globalMgr.height = whArr[1]-2;
		this.appPanel.setWidth(width);
		this.appPanel.setHeight(this.globalMgr.height);*/
	},
	/**
	 * 查询工具栏
	 */
			...
			handler : function(){
				...
				function btuclick(){
					if(arguments && arguments[0] == 'yes'){
						 	...
						 	self.globalMgr.DelBtn.setDisabled(flag);
							self.globalMgr.TJBtn.setDisabled(flag);
						 	}});
					} else{
						return;
					}
