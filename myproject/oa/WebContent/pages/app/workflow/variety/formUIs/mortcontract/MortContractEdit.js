...
define(function(require, exports) {
	exports.WinEdit = {
		...
		createAppWindow : function(){
			...
			this.appWin = new Ext.ux.window.AbsEditWindow({autoScroll : true,title:'抵押合同信息编辑'+'<span style="color:red">>>>填写的抵押合同编号必须唯一</span>',width:660,appFrm :this.appFrm,getUrls:this.getUrls,
