...
define(function(require, exports) {
	exports.moduleUI = {
		...
		createCmpts : function(){
			...
			this.auditRecordsPanel =  new Ext.Panel({autoScroll:true,height:600});
		...
		buildCmpts : function(){
		 	...
		 	if(!this.auditFormMod){
				...
				Cmw.importPackage('/pages/app/workflow/bussProcc/oa/mainUIs/AuditFormMod',function(module) {
			...
			if(!this.auditRecordsMod){
				...
				Cmw.importPackage('/pages/app/workflow/bussProcc/oa/mainUIs/AuditRecordsMod',function(module) {
