...
/**
 * @description 暂存的借款申请单管理 UI 
 * @date 2014-02-02 11:22
 */ 
cmw.oa.TempLoanApplyMgr = function(){
	this.init(arguments[0]);
}

Ext.extend(cmw.oa.TempLoanApplyMgr,Ext.util.MyObservable,{
	queryFields : null,
	initModule : function(tab,params){
		this.module = new Cmw.app.widget.AbsGContainerView({
			id : ComptIdMgr.tempLoanApplyMgrId,
			tab:tab,
			params:params,
