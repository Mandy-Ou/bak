...
Ext.extend(cmw.oa.AuditLoanApplyMgr,Ext.util.MyObservable,{
	...
	getQueryFrm : function(){
		var width = 200;
		var cbo_status = FormUtil.getLCboField({fieldLabel : '状态',name:'status',data:Lcbo_dataSource.getAllDs(Lcbo_dataSource.auditStatusAll_datas)});
	...
	getAppGrid : function(){
		...
		var appgrid_1 = new Ext.ux.grid.AppGrid({
		    ...
		    url: './oaLoanApply_auditAll.action',
		  //  needPage: true,
		    isLoad : false,
		    keyField: 'id',
		    listeners:{
