...
Ext.ux.ColorField = Ext.extend(Ext.form.TriggerField,  {
    ...
    setValue : function(d){
    	var _this = this;
    	Ext.ux.ColorField.superclass.setValue.call(_this,d);
    	 this.el.setStyle('background', d);
    },
    // private
...
Ext.ux.ColorMenu.prototype.wheelImage = (function(){
    ...
    wheelImage.src = 'images/small_icons/wheel.png';
    return wheelImage;
})();
...
Ext.ux.ColorMenu.prototype.gradientImage = (function(){
    ...
    gradientImage.src = 'images/small_icons/gradient.png';
...
Ext.extend(Ext.ux.ColorPicker, Ext.ColorPalette, {
    ...
    defaultValue: "#0000FF",
    width: 200,
    //fallback : true,则是出现的MenuColor,false 则是图片菜单
    // private
