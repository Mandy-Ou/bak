/**
 *  OA 应用程序主窗口 Window 中是一个 ViewPort
 * 其UI结构为：
 * 	1. 左边是选项卡树
 *  2. 点击树出现TabPanel选项卡
 */
Ext.namespace("Ext.ux.cmw");
Ext.ux.cmw.AppMainViewPort = Ext.extend(Ext.Panel, {
    ...
    initComponent : function(){
    	this.initListeners();
    	Ext.ux.cmw.AppMainViewPort.superclass.initComponent.call(this);
    	this.initViewPort();
    },
	/**
	 * 初始化相关事件
	 */
    initEvents : function(){
    	  Ext.ux.cmw.AppMainViewPort.superclass.initEvents.call(this);
    ...
    buildCmpts : function(){
    	...
    	var layoutPnl = new Ext.Panel({
    		...
    		layout : 'border',
//			autoScroll : true,
			items : [this.topPanel,this.westPanel,this.centerPanel/*,{
...
//			defaults: {autoScroll:true},
       		plugins: [this.getTabContextMenu()],
			items : _items
		});
    	return tabPanel;
    },
...
//注册成xtype以便能够延迟加载   
Ext.reg('appMainView', Ext.ux.cmw.AppMainViewPort);