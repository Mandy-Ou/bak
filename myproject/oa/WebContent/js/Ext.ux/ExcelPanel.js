...
Ext.ux.ExcelPanel = Ext.extend(Ext.Panel, 
{
	dso : null
	,store : null
	,xls : null
    ...
    ,open : function(filename)
    {
		...
		{
			alert( "���ļ����." + "["+ this.xls +"]:" + e.description);
		}
    }
    ...
    ,getCellValue : function(row,col)
    {
		...
		{
			alert( "Excelȡֵ���." + "["+ row +"," +col +"]" +e.description);
		}
    }
...
//注册成xtype以便能够延迟加载   
Ext.reg('ExcelPanel', Ext.ux.ExcelPanel);