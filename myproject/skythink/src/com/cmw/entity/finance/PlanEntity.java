...
public class PlanEntity extends IdBaseEntity {
	 ...
	 @Column(name="riamount" ,scale=2)
	 private BigDecimal riamount = new BigDecimal(0);

	 @Description(remark="返还管理费")
	 @Column(name="rmamount" ,scale=2)
	 private BigDecimal rmamount = new BigDecimal(0);

	 @Description(remark="返还罚息")
	 @Column(name="rpamount" ,scale=2)
	 private BigDecimal rpamount = new BigDecimal(0);

	 @Description(remark="返还滞纳金")
	 @Column(name="rdamount" ,scale=2)
	 private BigDecimal rdamount = new BigDecimal(0);
	...
	**/
	...
	public Object[] getDatas() {
		return new Object[]{getId(),contractId,phases,xpayDate,principal,interest,mgrAmount,penAmount,delAmount,totalAmount,reprincipal,yprincipal,yinterest,ymgrAmount,ypenAmount,ydelAmount,ytotalAmount,riamount,rmamount,rpamount,rdamount,trinterAmount,trmgrAmount,trpenAmount,trdelAmount,pdays,ratedays,mgrdays,lastDate,pistatus,mgrstatus,status,exempt,provision,isenabled,extNo,extcontractId,trDate};
	}

	@Override
	public String[] getFields() {
		return new String[]{"id","contractId","phases","xpayDate#yyyy-MM-dd","principal","interest","mgrAmount","penAmount","delAmount","totalAmount","reprincipal","yprincipal","yinterest","ymgrAmount","ypenAmount","ydelAmount","ytotalAmount","riamount","rmamount","rpamount","rdamount","trinterAmount","trmgrAmount","trpenAmount","trdelAmount","pdays","ratedays","mgrdays","lastDate","pistatus","mgrstatus","status","exempt","provision","isenabled","extNo","extcontractId","trDate#yyyy-MM-dd"};
	}
