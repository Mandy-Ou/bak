 ...
 */
@Description(remark="还款计划备份表实体",createDate="2014-01-07T00:00:00",author="程明卫")
@Entity
@Table(name="fc_PlanBackup")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("serial")
public class PlanBackupEntity extends IdBaseEntity {
	
	 @Description(remark="备份总表ID")
	 @Column(name="overalLogId" ,nullable=false )
	 private Long overalLogId;
	...
	/**
	 * 备份总表ID
	 * @return overalLogId 备份总表ID
	 */
	public Long getOveralLogId() {
		return overalLogId;
	}

	/**
	  * 设备份总表ID的值
	 * @param 	overalLogId	备份总表ID
	**/
	public void setOveralLogId(Long overalLogId) {
		this.overalLogId = overalLogId;
	}
