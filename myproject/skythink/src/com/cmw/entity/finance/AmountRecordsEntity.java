 ...
 */
@Description(remark="实收金额实体",createDate="2013-01-15T00:00:00",author="程明卫")
@Entity
@Table(name="fc_AmountRecords")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("serial")
public class AmountRecordsEntity extends IdBaseEntity {
	
	@Description(remark="借款合同ID")
	 @Column(name="contractId" ,nullable=false )
	 private Long contractId;
	
	 @Description(remark="还款期数ID")
	 ...
	 @Description(remark="随借随还记录ID")
	 @Column(name="casualId" )
	 private Long casualId;
	 
	public AmountRecordsEntity() {
	...
	**/
	...
	public Object[] getDatas() {
		return new Object[]{id,contractId,invoceId,bussTag,cat,rat,mat,pat,dat,fat,tat,rectDate,accountId,fcnumber,rectDate,casualId};
	}

	@Override
	public String[] getFields() {
		return new String[]{"id","contractId","invoceId","bussTag","cat","rat","mat","pat","dat","fat","tat","rectDate","accountId","fcnumber","rectDate#yyyy-MM-dd","casualId"};
	}
