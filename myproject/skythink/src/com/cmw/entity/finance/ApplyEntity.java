...
public class ApplyEntity extends IdBaseEntity {
	 ...
	 @Description(remark="主贷款方式")
	 @Column(name="mainLoanType" ,length=30 )
	 ...
	 @Column(name="borBank" ,length=50 )
	 private String borBank;

	 @Description(remark="借款帐号")
	 @Column(name="borAccount" ,length=50 )
	 ...
	 @Description(remark="民汇内部利率")
	 @Column(name="inRate" ,scale=2)
	 private Double inRate = 0d;
	 
	 @Description(remark="民汇内部利率类型")
	 @Column(name="inRateType" ,scale=2)
	 private Integer inRateType;
	 
	 
	 @Description(remark="最后结清日期")
	...
	/**设置主贷款方式
	 * @param mainLoanType the mainLoanType to set
	 */
	public void setMainLoanType(String mainLoanType) {
	...
	/** 返回民汇内部利率类型
	 * @return the inRateType
	 */
	public Integer getInRateType() {
		return inRateType;
	}
	...
	/**设置民汇内部利率类型
	 * @param inRateType the inRateType to set
	 */
	public void setInRateType(Integer inRateType) {
