...
public class PledgeEntity extends IdBaseEntity {
	...
	**/
	...
	public Object[] getDatas() {
		return new Object[]{id,isenabled,formId,gtype,name,quantity,unint,oldVal,mpVal,mman,conTel,morTime,address,carrTime,carrMan,charTime,charMan,state};
	}

	@Override
	public String[] getFields() {
		return new String[]{"id","isenabled","formId","gtype","name","quantity","unint","oldVal","mpVal","mman","conTel","morTime#yyyy-MM-dd","address","carrTimeyyyy-MM-dd HH:mm","carrMan","charTimeyyyy-MM-dd HH:mm","charMan","state"};
	}
