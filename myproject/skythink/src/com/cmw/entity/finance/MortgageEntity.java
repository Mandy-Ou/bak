...
public class MortgageEntity extends IdBaseEntity {
	...
	**/
	...
	public Object[] getDatas() {
		return new Object[]{id,formId,gtype,name,quantity ,unint,oldVal,mpVal,mman,conTel,morTime,address,carrTime,carrMan,charTime,charMan ,state,remark};
	}

	@Override
	public String[] getFields() {
		return new String[]{"id","formId","gtype","name","quantity ","unint","oldVal","mpVal","mman","conTel","morTime#yyyy-MM-dd","address","carrTime#yyyy-MM-dd HH:mm","carrMan","charTime#yyyy-MM-dd HH:mm","charMan ","state","remark"};
	}
