 ...
 */
@Description(remark="银行借款情况实体",createDate="2012-12-26T00:00:00",author="pdh")
@Entity
@Table(name="crm_EbankBorr")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("serial")
public class EbankBorrEntity extends IdBaseEntity {
	...
	**/
	...
	public Object[] getDatas() {
		return new Object[]{id,isenabled,ecustomerId,name,amount,limits,creditBreed,asstype,result,remark};
	}

	@Override
	public String[] getFields() {
		return new String[]{"id","isenabled","ecustomerId","name","amount","limits","creditBreed","asstype","result","remark"};
	}
