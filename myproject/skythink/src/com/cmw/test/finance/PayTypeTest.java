...
//		loanContractEntity.setAppAmount(new BigDecimal(300000));
		...
		params.put("realDate", invoceEntity.getPayDate());//DateUtil.dateFormat("2013-01-01"));//invoceEntity.getRealDate()
		params.put("payAmount", invoceEntity.getPayAmount());
		
		
		List<PlanEntity> planList = planService.getEntityList(map);
		String payType = loanContractEntity.getPayType();
		...
		System.out.println("code="+loanContractEntity.getCode()); //B2014020611292812
