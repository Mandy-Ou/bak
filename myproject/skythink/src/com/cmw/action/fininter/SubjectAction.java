 ...
 */
@Description(remark="科目ACTION",createDate="2013-03-28T00:00:00",author="程明卫",defaultVals="fsSubject_")
@SuppressWarnings("serial")
public class SubjectAction extends BaseAction {
	@Resource(name="acctGroupService")
	private AcctGroupService acctGroupService;
	...
	public String list()throws Exception {
		try {
			SHashMap<String, Object> map = getQParams("groupId#L,finsysId#L,name");
			map.put(SysConstant.USER_KEY, this.getCurUser());
			DataTable dt = subjectService.getResultList(map,getStart(),getLimit());
	...
	public String synchronous()throws Exception {
		try {
			...
			params.put("objectName", "AcctGroupEntity");
			List<AcctGroupEntity> list = fservice.getAcctGroups(params);
			acctGroupService.batchSaveEntitys(list);
			
			params.put("objectName", "SubjectEntity");
			List<SubjectEntity> subjectList = fservice.getSubjects(params);
			subjectService.batchSaveEntitys(subjectList);
	...
	public String get()throws Exception {
		try {
			...
			SubjectEntity entity = subjectService.getEntity(Long.parseLong(id));
	...
	public String save()throws Exception {
		try {
			SubjectEntity entity = BeanUtil.copyValue(SubjectEntity.class,getRequest());
			subjectService.saveOrUpdateEntity(entity);
	...
	public String add()throws Exception {
		try {
			Long num = subjectService.getMaxID();
	...
	public String enabled(String sucessMsg)throws Exception {
		try {
			...
			subjectService.enabledEntitys(ids, isenabled);
	...
	public String prev()throws Exception {
		try {
			...
			SubjectEntity entity = subjectService.navigationPrev(params);
	...
	public String next()throws Exception {
		try {
			SHashMap<String,Object> params = getQParams("id");
			SubjectEntity entity = subjectService.navigationNext(params);
