 ...
 */
@Description(remark="核算项类别ACTION",createDate="2013-03-28T00:00:00",author="程明卫",defaultVals="fsItemClass_")
@SuppressWarnings("serial")
public class ItemClassAction extends BaseAction {
	...
	public String list()throws Exception {
		try {
			SHashMap<String, Object> map = getQParams("finsysId#L,code,name");
			map.put(SysConstant.USER_KEY, this.getCurUser());
			DataTable dt = itemClassService.getResultList(map,getStart(),getLimit());
	...
	public String synchronous()throws Exception {
		try {
			...
			params.put("objectName", "ItemClassEntity");
			List<ItemClassEntity> list = fservice.getItemClasses(params);
			itemClassService.batchSaveEntitys(list);
	...
	public String get()throws Exception {
		try {
			...
			ItemClassEntity entity = itemClassService.getEntity(Long.parseLong(id));
	...
	public String save()throws Exception {
		try {
			ItemClassEntity entity = BeanUtil.copyValue(ItemClassEntity.class,getRequest());
			itemClassService.saveOrUpdateEntity(entity);
	...
	public String update()throws Exception {
		try {
			Long id = getLVal("id");
			Long bussObjectId = getLVal("bussObjectId");
			if(!StringHandler.isValidObj(id)) throw new ServiceException(ServiceException.ID_IS_NULL);
			ItemClassEntity entity = itemClassService.getEntity(id);
			entity.setBussObjectId(bussObjectId);
			BeanUtil.setModifyInfo(getCurUser(), entity);
			itemClassService.updateEntity(entity);
			result = ResultMsg.getSuccessMsg(this, ResultMsg.SAVE_SUCCESS);
		} catch (ServiceException ex){
			result = ResultMsg.getFailureMsg(this,ex.getMessage());
			if(null == result) result = ex.getMessage();
	...
	public String add()throws Exception {
		try {
			Long num = itemClassService.getMaxID();
	...
	public String enabled(String sucessMsg)throws Exception {
		try {
			...
			itemClassService.enabledEntitys(ids, isenabled);
	...
	public String prev()throws Exception {
		try {
			...
			ItemClassEntity entity = itemClassService.navigationPrev(params);
	...
	public String next()throws Exception {
		try {
			SHashMap<String,Object> params = getQParams("id");
			ItemClassEntity entity = itemClassService.navigationNext(params);
