...
public interface LoanInvoceService extends IService<LoanInvoceEntity, Long> {
	 ...
	 * @throws DaoException
	 */
	<K, V> DataTable getNeedYsList(SHashMap<K, V> params, int offset, int pageSize)throws ServiceException;
	/**
	 * @param map
	 * @throws ServiceExceptionssssssssss
	 */
	void saveYs(SHashMap<String, Object> map) throws ServiceException;
}
