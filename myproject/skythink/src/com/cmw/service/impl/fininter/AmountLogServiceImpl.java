...
//	
	...
	public Map<AmountLogEntity,DataTable> saveByBussTag(SHashMap<String, Object> params) throws ServiceException {
		...
		try{
			...
			case BussStateConstant.AMOUNTLOG_BUSSTAG_0:{
				...
				break;
			}case BussStateConstant.AMOUNTLOG_BUSSTAG_12:/*12:随借随还收款*/
			case BussStateConstant.AMOUNTLOG_BUSSTAG_13:/*13:随借随还息费返还*/
			case BussStateConstant.AMOUNTLOG_BUSSTAG_14:{/*14:随借随还豁免*/	
				tabEntity = "CasualRecordsEntity";
	...
	private Map<AmountLogEntity,DataTable> createAmountLogsByCasualRecords(String ids,UserEntity user,Integer bussTag,VoucherTempEntity vtempEntity) throws DaoException{
		...
		Long accountId = null;
		int custCount = 1;
		Integer tactics = (null != vtempEntity) ? vtempEntity.getTactics() : null;
		if(null == tactics || tactics.intValue() == BussStateConstant.VOUCHERTEMP_TACTICS_1){/*一笔业务生成一张凭证*/
