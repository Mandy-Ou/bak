 ...
 */
 @Description(remark="实收金额Dao接口",createDate="2013-01-15T00:00:00",author="程明卫")
public interface AmountRecordsDaoInter  extends GenericDaoInter<AmountRecordsEntity, Long>{
	 /**
		 * 获取正常扣收数据
		 * @param params	查询参数
		 * @param offset	分页起始位
