...
public class BalanceReportDaoImpl extends GenericDaoAbs<Object, Long> implements BalanceReportDaoInter {
	...
	private <K, V> DataTable getReportByYear(SHashMap<K, V> map){
		...
		sbSql.append("select  A.loanMain, A.inType, A.mainLoanType,A.loanType, A.breed,")
		...
		.append(" where 1=1 ");
		String colNames = "loanMain,inType,mainLoanType,loanType,breed,loanLimit,appAmount,zprincipals,loanCount";
