...
public class LoanSortReportDaoImpl extends GenericDaoAbs<LoanInvoceEntity, Long> implements LoanSortReportDaoInter {
	...
	private <K, V> DataTable getReportByMonth(SHashMap<K, V> map){
		...
		sbSql.append("select B.id as contractId,A.loanMain,A.inType,A.loanType,A.mainLoanType,A.breed,Datediff(MM,B.payDate,B.endDate) as loanLimit,")
		...
		.append(" where 1=1 ");
		String colNames = "contractId,loanMain,inType,loanType,mainLoanType,breed,loanLimit,appAmount,payAmounts,loanCount";
