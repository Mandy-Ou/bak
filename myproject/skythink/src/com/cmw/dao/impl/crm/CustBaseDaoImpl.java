	...
	public <K, V> DataTable getResultList(SHashMap<K, V> params, int offset,
		...
		try{
			if(custType.intValue() == SysConstant.CUSTTYPE_0){	//个人客户
				...
				colNames = "id,isenabled,sysId,customerId,custLevel,code,name,sex,cardType,cardNum,custType,serialNum,birthday#yyyy-MM-dd,age,contactTel,phone,regman,deptid,registerTime#yyyy-MM-dd,refId,bid";
				...
				.append("B.contactTel,B.phone,C.empName as regman,B.deptid,B.registerTime,A.refId,B.id as bid")
				...
				colNames = "id,isenabled,sysId,serialNum,ecustomerId,custLevel," +
						...
						"regman,registerTime#yyyy-MM-dd,refId,custType,bid";
				...
				.append(" D.name as kind,B.contactor,B.phone,B.contactTel,(B.address+'##'+B.inAddress) as address,C.empName as regman,B.registerTime,A.refId,A.custType,B.id as bid ")
