...
define(function(require, exports) {
	exports.WinEdit = {
		...
		getParams : function() {
			...
			var params = {id : selId,custType:Buss_Constant.CustType_1};
			return params;
		},
		/**
		...
		createDetailPnl : function() {
			...
			'<tr><th col="code">放款单编号</th> <td col="code" >&nbsp;</td><th col="ccode">借款合同号</th> <td col="ccode" >&nbsp;</td><th col="name">客户姓名</th> <td col="name" >&nbsp;</td></tr>',
					'<tr><th col="cashier">放款人</th> <td col="cashier" >&nbsp;</td><th col="appAmount">贷款金额</th> <td col="appAmount" colspan =3>&nbsp;</td></tr>',
					...
					'<tr><th col="rate">贷款利率</th> <td col="rate" >&nbsp;</td><th col="payName">收款人名称</th> <td col="payName">&nbsp;</td><th col="inRate">公司内部利率</th> <td col="inRate">&nbsp;</td></tr>',
					'<tr><th col="realDate">实际放款日</th> <td col="realDate">&nbsp;</td><th col="mrate">管理费率</th> <td col="mrate" colspan =3>&nbsp;</td></tr>',
			...
			var detailCfgs_1 = [{
				...
				callback : {
					sfn : function(jsonData) {
						...
						var Gaccouont = jsonData["Gaccouont"];
