...
/**
 * 质押合同查询 UI smartplatform_auto 2012-08-10 09:48:16
 */ 
cmw.skythink.PleSearchMgr = function(){
	this.init(arguments[0]);
}

Ext.extend(cmw.skythink.PleSearchMgr,Ext.util.MyObservable,{
	...
	getQueryFrm : function(){
		var self =this;
		var wd = 180;
		var Txt_code = FormUtil.getTxtField({fieldLabel : '质押合同编号',name:'code',width:wd});
		...
		var Txt_ownerNums = FormUtil.getTxtField({fieldLabel : '权属编号',name:'ownerNums',width:wd});
		var layout_fields = [{cmns:'THREE',fields:[Txt_code,Txt_borrCode,Txt_assMan,Txt_appAmount,Txt_rate,Txt_ownerNums]}]
