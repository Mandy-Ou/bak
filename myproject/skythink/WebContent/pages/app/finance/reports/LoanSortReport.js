...
/**
 * 贷款发放分类报表 UI chengmingwei 2013-08-07 14:52
 */ 
...
Ext.extend(skythink.cmw.report.LoanSortReport,Ext.util.MyObservable,{
	...
	globalMgr : {
		...
		createReportGrid : function(_this,reportPanelId){
				var headTabHtml = [
					 '<table style="width:1000px;" class="report_header_table">',
				     ' <col width="125"><col width="185"><col width="110"><col width="110">',
				      ' <col width="125"><col width="110"><col width="110"><col width="125">',
				        '<tr>',
			...
			var cfg = {url : './fcLoanSortReport_list.action',
				parentId:reportPanelId,headTabHtml:headTabHtml.join(" "),
				cellWidthArr:[125,185,108,108,120,110,115,131],
				width:1020,offset:29
			};
