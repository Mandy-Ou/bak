...
/**
 * 暂存的息费豁免审批 UI smartplatform_auto 2013-09-21 12:20:16
 */ 
cmw.skythink.AuditExemptMgr = function(){
	this.init(arguments[0]);
}

Ext.extend(cmw.skythink.AuditExemptMgr,Ext.util.MyObservable,{
