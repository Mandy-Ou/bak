...
/**
 * 个人客户贷款审批历史 UI smartplatform_auto 2012-08-10 09:48:16
 */ 
cmw.skythink.AuditCustApplyHistory = function(){
	this.init(arguments[0]);
}

Ext.extend(cmw.skythink.AuditCustApplyHistory,Ext.util.MyObservable,{
	initModule : function(tab,params){
		this.module = new Cmw.app.widget.AbsGContainerView({
			id : ComptIdMgr.auditCustApplyHistoryId,
			tab : tab,
			params : params,
			hasTopSys : false,
