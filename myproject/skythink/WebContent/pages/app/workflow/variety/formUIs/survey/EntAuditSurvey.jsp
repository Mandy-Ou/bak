...
<Button id="ED_TL_<%=tabId%>">编辑</Button>
<Button id="SV_TL_<%=tabId%>">取消</Button>
</span>
</p>
...
<Button id="SV_TL_<%=tabId%>"  onClick="AuditProjectMgr.save(this,'C5_C2_ET3')" disabled="disabled">取消</Button>
</span>
</p>
<table id="<%=tabId%>" width="100%" border="1" cfg="{type:0,edcmns:[ 
{id:'R1_CN1',type:1},
