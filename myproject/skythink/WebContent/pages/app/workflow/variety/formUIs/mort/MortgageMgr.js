...
//		detailpanel.doLayout();
	...
	getToolBar : function(self){
		var barItems = [{
			...
			handler : function(){
				EventManager.deleteData('./fcMortgage_delete.action',{type:'grid',cmpt:self.globalMgr.appgrid,formId:self.globalMgr.formId,optionType:OPTION_TYPE.DEL,self:self});
			}
		}];
