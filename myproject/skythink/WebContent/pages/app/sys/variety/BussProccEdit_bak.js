...
define(function(require, exports) {
	exports.WinEdit = {
		...
		createAppPanel : function(){
			...
			var threeCmnPanel = FormUtil.getLayoutPanel([this.leftWidth,rightWidth],[this.appFrm,this.nodeCfgFrm]);
		...
		createTransGrid : function(){
			...
			var showValidFn = function(cbogd){
				...
				var acTypeName = record.get("acTypeName");
		...
		addListenersToButtons : function(){
			...
			function clickDoDtas(parentCfg){
				parentCfg.params = {sysId : _this.parentCfg.sysId,code:ACCORDION_CODE_TYPE_FORM_PREFIX};
