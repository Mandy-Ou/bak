...
//				var subid = selId.replace(/[^0-9]+/ig,"");
//				alert("selId="+selId);
				var rname = exports.WinEdit.parentCfg.self.apptree.getSelText();
		...
		createForm : function(){
			...
			/*资源编号*/
			var txt_Code = FormUtil.getReadTxtField({fieldLabel : '编号',name:'code',allowBlank:false,width:200,maxLength:50});
			/*默认名称*/
			...
			/*菜单图标*/
			var txa_biconCls = FormUtil.getMyImgChooseField({
			    fieldLabel: '系统图标',
			    width : 200,
			    name: 'biconCls',
			    showIconTypes : [2,3],
			...
			var layout_fields  = [hid_isenabled,hid_id,hid_RestypeId,txt_Rname,txt_Code,txt_Name,txt_Jname,txt_Twname,txt_Fname,txt_Koname,txa_biconCls,txa_remark];
			
			var frm_cfg = {title : '资源编辑',url:'./sysGvlist_save.action',height:330};
