...
define(function(require, exports) {
	exports.moduleUI = {
		...
		createCmpts : function(){
			...
			this.auditFormParentPanel = new Ext.Panel({autoScroll:true,autoWidth:true});
			this.auditRecordsPanel =  new Ext.Panel({autoScroll:true,height:height});
			this.appPanel = new Ext.Panel({border:false,autoScroll:true,items:[this.auditFormParentPanel,this.auditRecordsPanel]});
		},
		/**
		 * 组装控件
		 */
		buildCmpts : function(){
		 	...
		 	if(!this.auditFormMod){
				...
				Cmw.importPackage('/pages/app/workflow/bussProcc/mainUIs/AuditFormMod',function(module) {
			...
			if(!this.auditRecordsMod){
				...
				Cmw.importPackage('/pages/app/workflow/bussProcc/mainUIs/AuditRecordsMod',function(module) {
