...
/**
 * 企业客户贷款审批历史 UI smartplatform_auto 2012-12-29 09:48:16
 */ 
cmw.skythink.AuditEntCustApplyHistory = function(){
	this.init(arguments[0]);
}

Ext.extend(cmw.skythink.AuditEntCustApplyHistory,Ext.util.MyObservable,{
	initModule : function(tab,params){
		this.module = new Cmw.app.widget.AbsGContainerView({
			id : ComptIdMgr.auditEntCustApplyHistoryId,
			tab : tab,
			params : params,
			hasTopSys : false,
	...
	getAppGrid : function(){
		var _this = this;
			...
			var appgrid_1 = new Ext.ux.grid.AppGrid({
			    ...
			    url: './fcApply_audithostorys.action',
			    needPage: true,
			    keyField: 'id',
			    width:600,
			    isLoad: false,
