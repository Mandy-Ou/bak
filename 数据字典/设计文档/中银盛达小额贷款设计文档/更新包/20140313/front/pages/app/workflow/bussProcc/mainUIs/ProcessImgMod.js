	...
	exports.moduleUI = {
		...
		getModule : function(params){
			if(!this.appPanel){
				...
				var html = '<div id="'+this.processDivId+'"><image id="'+this.processImageId+'"  style="position:relative; left:0px; top:0px;"></div>';
				this.appPanel = new Ext.Panel({autoScroll:true,html:html});
				this.show(params);
			}
