...
//			    "allowBlank": false,
			...
			var ysRatMonth = FormUtil.getIntegerField({
				...
				listeners :{
					change:function(o,newValue,oldValue){
						var appAmount = txt_appAmount.getValue();
						var rate = dob_rate.getValue();
						var ysrat = parseFloat(appAmount)*parseFloat(rate)/100*newValue;
						ysRat.setValue(ysrat);
					}
				}
			});
			...
			var ysMatMonth = FormUtil.getIntegerField({
				...
				listeners :{
					change:function(o,newValue,oldValue){
						var appAmount = txt_appAmount.getValue();
						var mrate = dob_mrate.getValue();
						var ysmat = parseFloat(appAmount)*parseFloat(mrate)/100*newValue;
						ysMat.setValue(ysmat);
					}
				}
			});
			...
			var layout_fields = [txt_id, txt_formId, txt_contractId,{
			    ...
			    fields: [ txt_loancode,txt_code,
			    		...
			    		txt_cashier,dob_inRate,ysRatMonth,ysMatMonth,ysRat,ysMat
		    			]
