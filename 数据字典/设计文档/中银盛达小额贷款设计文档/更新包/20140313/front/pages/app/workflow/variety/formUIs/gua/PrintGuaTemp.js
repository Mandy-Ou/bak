...
//		parent:null,
		...
		createAppWindow : function(){
			...
			var htmlArr = ['<iframe id="'+this.iframeId+'" name="'+this.iframeId+'"  width="100%" style="width:100%; height:100%;margin-left:20px;margin-right:20px; " frameborder="0"></iframe>',
...
//					window.parent.frames[_this.iframeId].PrintMgr.design();
		...
		loadData : function(_params,panel){
			var _this=this;
			var count="id,contractId";
				EventManager.get("./fcPrintTemp_getClause.action",{params:{count:count,id:this.tempId,contractId:_params.contractId,printType:_params.printType},sfn : function(jsonData){
					_this.content=jsonData.content;
				 	var concatHtml = ["<div width='80%' style='margin-left:10%;margin-right:10%;margin-bottom:10%;'>"+_this.content+"</div>"];
