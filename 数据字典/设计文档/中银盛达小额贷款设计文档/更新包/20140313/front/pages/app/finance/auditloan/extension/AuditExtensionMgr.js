...
/**
 * 展期审批 UI smartplatform_auto 2013-09-24 16:19:16
 */ 
cmw.skythink.AuditExtensionMgr = function(){
	this.init(arguments[0]);
}

Ext.extend(cmw.skythink.AuditExtensionMgr,Ext.util.MyObservable,{
	...
	getAppGrid : function(){
		var _this = this;
			...
			var appgrid_1 = new Ext.ux.grid.AppGrid({
			    ...
			    url: './fcExtension_auditlist.action',
			    needPage: true,
			    keyField: 'id',
			    width:600,
			    isLoad: false,
