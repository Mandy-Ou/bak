...
define(function(require, exports) {
	exports.moduleUI = {
		...
		initIdMgr : function(){
			...
			this.idMgr =  {
				menuLabelId : menuLabelId,/*菜单事项总提示ID,由 AuditMainUI.js 传入，目的是控制当不是当前任务审批人时，隐藏 必做/选做事项提示*/
		...
		openUI : function(eleId,selData){
			...
			if(this.bussUiMgr){
				...
				var _this = this;
				Cmw.importPackage('pages/app/workflow/variety/mainUIs/BussMgrMod',function(module) {
		...
		updateCountByFormSave : function(num){
			...
			if(fmustCount && fmustCount >= this.bussCounterMgr.mustTotalCount){
				...
				if(this.callback){
					var delay = new Ext.util.DelayedTask(function(){//延迟show 出审批面板信息以便使必做事项和选做事项的数据加载完成
						_this.callback(_params);
					});
					delay.delay(500);
