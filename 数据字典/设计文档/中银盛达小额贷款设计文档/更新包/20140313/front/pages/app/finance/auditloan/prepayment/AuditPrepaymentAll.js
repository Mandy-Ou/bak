...
/**
 * 提前还款审批一览表 UI smartplatform_auto 2013-09-13 14:58:16
 */ 
cmw.skythink.AuditPrepaymentAll = function(){
	this.init(arguments[0]);
}

Ext.extend(cmw.skythink.AuditPrepaymentAll,Ext.util.MyObservable,{
	...
	getAppGrid : function(){
		var _this = this;
			...
			var appgrid_1 = new Ext.ux.grid.AppGrid({
			    ...
			    url: './fcPrepayment_auditAll.action',
			    needPage: true,
			    keyField: 'id',
			    width:600,
			    isLoad: false,
