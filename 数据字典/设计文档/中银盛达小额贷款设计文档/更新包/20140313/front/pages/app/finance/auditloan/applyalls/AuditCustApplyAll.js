...
/**
 * 个人客户贷款一览表 UI smartplatform_auto 2012-08-10 09:48:16
 */ 
cmw.skythink.AuditCustApplyAll = function(){
	this.init(arguments[0]);
}

Ext.extend(cmw.skythink.AuditCustApplyAll,Ext.util.MyObservable,{
	initModule : function(tab,params){
		this.module = new Cmw.app.widget.AbsGContainerView({
			id : ComptIdMgr.auditCustApplyAllId,
			tab : tab,
			params : params,
			hasTopSys : false,
