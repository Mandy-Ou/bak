...
/**
 * 企业客户贷款一览表 UI smartplatform_auto 2012-12-29 09:48:16
 */ 
cmw.skythink.AuditEntCustApplyAll = function(){
	this.init(arguments[0]);
}

Ext.extend(cmw.skythink.AuditEntCustApplyAll,Ext.util.MyObservable,{
	initModule : function(tab,params){
		this.module = new Cmw.app.widget.AbsGContainerView({
			id : ComptIdMgr.auditEntCustApplyAllId,
			tab : tab,
			params : params,
			hasTopSys : false,
