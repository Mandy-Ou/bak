 ...
 */
Msg_LoginWindow = {
	win_title : '中银盛达小额贷款 业务平台',
	tab_one_title : '身份认证',
	tab_two_title : '关于本系统',
	tab_two_html : '同心日小额贷款系统V2.5 <br><br>'
...
Msg_SysTip = {
	...
	msg_orderNoEdit : '[提示:<span style="color:red;">业务顺序可修改</span>]',
	msg_addCustomer_noparams : '添加客户资料时，请提供参数  {params : {formDatas : {}}} !',
	msg_editCustomer_noparams : '修改客户资料时，请提供参数  {params : {customerInfoId : 1001} !',
	...
	msg_state_Change : '正在转换数据...',
	msg_state_Settle : '数据转换成功！'
};
/**
...
var Btn_Cfgs = {
	...
	DEPARTMENT_EDIT_BTN_TXT : '修改部门',
	DEPARTMENT_EDIT_BTN_FASTKEY : '',
	DEPARTMENT_EDIT_BTN_CLS : 'page_edit',
	DEPARTMENT_EDIT_TIP_BTN_TXT : '修改部门',
	...
	POST_EDIT_BTN_TXT : '修改职位',
	POST_EDIT_BTN_FASTKEY : '',
	POST_EDIT_BTN_CLS : 'page_edit',
	POST_EDIT_TIP_BTN_TXT : '修改职位',
	...
	RESTYPE_EDIT_BTN_TXT : '修改资源',
	RESTYPE_EDIT_BTN_FASTKEY : '',
	RESTYPE_EDIT_BTN_CLS : 'page_edit',
	RESTYPE_EDIT_TIP_BTN_TXT : '修改资源',
	...
	GVLIST_EDIT_BTN_TXT : '修改数据',
	GVLIST_EDIT_BTN_FASTKEY : '',
	GVLIST_EDIT_BTN_CLS : 'page_edit',
	GVLIST_EDIT_TIP_BTN_TXT : '修改数据',
	...
	FORMDIY_EDIT_ADD_TXT : "修改表单",
	FORMDIY_EDIT_BTN_FASTKEY : '',
	FORMDIY_EDIT_TIP_BTN_TXT : "修改表单",
	...
	FIELDCUSTOM_EDIT_ADD_TXT : "修改字段",
	FIELDCUSTOM_ADD_BTN_FASTKEY : '',
	FIELDCUSTOM_EDIT_TIP_BTN_TXT : "修改字段",
	...
	FIELDPROP_EDIT_ADD_TXT : "修改字段属性",
	FIELDPROP_ADD_BTN_FASTKEY : '',
	FIELDPROP_EDIT_TIP_BTN_TXT : "修改字段属性",
	...
	POSTPONE_BTN_TXT : '顺延',
	POSTPONE_FASTKEY : '',
	POSTPONE_CLS : 'page_confirm',
	POSTPONE_TIP_BTN_TXT : '顺延',
	...
	EDIT_VARIETY_BTN_TXT : '修改品种',
	EDIT_VARIETY_FASTKEY : '',
	EDIT_VARIETY_CLS : 'page_edit',
	EDIT_VARIETY_TIP_BTN_TXT : '修改品种',
	...
	EDIT_BUSSPROCC_BTN_TXT : '修改子流程',
	EDIT_BUSSPROCC_FASTKEY : '',
	EDIT_BUSSPROCC_CLS : 'page_edit',
	EDIT_BUSSPROCC_TIP_BTN_TXT : '修改子流程',
	...
	EDIT_CLAUSE_BTN_TXT : '修改条款',
	EDIT_CLAUSE_FASTKEY : '',
	EDIT_CLAUSE_CLS : 'page_edit',
	EDIT_CLAUSE_TIP_BTN_TXT : '修改条款',
	...
	DO_RETURN_BTN_TXT : '息费返还',
	DO_RETURN_FASTKEY : '',
	DO_RETURN_CLS : 'page_confirm',
	DO_RETURN_TIP_BTN_TXT : '退还多收的利息、管理费、罚息、滞纳金',
	
	DO_EXEMPT_BTN_TXT : '息费豁免',
	DO_EXEMPT_FASTKEY : '',
	DO_EXEMPT_CLS : 'page_remover',
	DO_EXEMPT_TIP_BTN_TXT : '减免客户应还利息、管理费、罚息、滞纳金',
	
	DO_FINISH_BTN_TXT : '结清',
	DO_FINISH_FASTKEY : '',
	DO_FINISH_CLS : 'page_confirm',
	DO_FINISH_TIP_BTN_TXT : '标识客户结清所有本息费',
	...
	FORMULA_EDIT_BTN_TXT : '修改公式',
	FORMULA_EDIT_BTN_FASTKEY : '',
	FORMULA_EDIT_BTN_CLS : 'page_edit',
	FORMULA_EDIE_TIP_BTN_TXT : '修改公式',
	...
	FORMULA_DELETE_BTN_TXT : '删除公式',
	FORMULA_DELETE_BTN_FASTKEY : '',
	FORMULA_DELETE_BTN_CLS : 'page_delete',
	FORMULA_DELETE_TIP_BTN_TXT : '删除公式',
	...
	GUA_EDIT_BTN_TXT : '修改保证合同',
	GUA_EDIT_BTN_FASTKEY : '',
	GUA_EDIE_TIP_BTN_TXT : '修改保证合同',
	...
	LOAN_EDIT_BTN_TXT : '修改借款合同',
	LOAN_EDIT_BTN_FASTKEY : '',
	LOAN_EDIE_TIP_BTN_TXT : '修改借款合同',
	...
	LOANINVOCE_EDIT_BTN_TXT : '修改放款单',
	LOANINVOCE_EDIT_BTN_FASTKEY : '',
	LOANINVOCE_EDIE_TIP_BTN_TXT : '修改放款单',
	...
	MORTCONTRACT_EDIT_BTN_TXT : '修改抵押合同',
	MORTCONTRACT_EDIT_BTN_FASTKEY : '',
	MORTCONTRACT_EDIE_TIP_BTN_TXT : '修改抵押合同',
	...
	PLECONTRACT_EDIT_BTN_TXT : '修改质押合同',
	PLECONTRACT_EDIT_BTN_FASTKEY : '',
	PLECONTRACT_EDIE_TIP_BTN_TXT : '修改质押合同',
	...
	EXTCONTRACT_EDIT_BTN_TXT : "修改展期协议书",
	EXTCONTRACT_EDIT_BTN_FASTKEY : '',
	EXTCONTRACT_EDIT_BTN_TIP_TXT : "修改展期协议书",
...
,		/*==================系统基础平台按钮配置==========*/
		...
		ROLE_CANCEL_BTN_TXT : '取消权限',
		ROLE_SAVE_BTN_FASTKEY : '',
		ROLE_CANCEL_BTN_CLS : 'page_disabled',
		ROLE_CANCEL_TIP_BTN_TXT :'取消权限',
...
var Lcbo_dataSource = {
	...
	/**
	 * 利率单位
	 * Lcbo_dataSource.rateUnit_datas
	 * @type 
	 */
	rateUnit_datas :  [["1", "%"]],//[["1", "%"],["2", "‰"]],
	/**
	 * 利率类型
	 * Lcbo_dataSource.rateType_datas
	 * @type 
	 */
	rateType_datas : [["1", "固定值"],["2", "上浮"]],
	/**
	 * 获取逻辑运算符下拉框数据源
	 * 
	 * @type
	 ...
	 * @type
	 */
	setdayType_datas : [["1", "实际放款日当结算日"], ["2", "公司规定的结算日"], ["3", "其它节算日"]],
	/**
	 * 可用标识数据
	 * 
	 * @type
	 ...
	 * @type
	 */
	cardType_datas : [["0", "身份证"], ["1", "驾驶证"], ["2", "护照"],
			["3", "营业执照)"]],
...
var Render_dataSource = {
	...
	guaCardTypeRender : function(val){
		switch (val) {
			case "0" :
				val = '身份证';
				break;
...
custTypeRender : function(val) {
	 ...
	 * @param {}
	 *            val
	 * @return {} ptformula_ftypeRender(0);
	 */
	ptformula_ftypeRender : function(val) {
